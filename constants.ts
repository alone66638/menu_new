...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'm111', category: Category.MEAT, name: '酱香鸡爪', price: 55, image: new URL('./img/jizhua.png', import.meta.url).href },
  // m6 moved to TOP
  // m7 moved to TOP
  // m8 moved to TOP
  ...
  { id: 'v9', category: Category.VEGETABLE, name: '炒蒜薹', price: 28, image: new URL('./img/suanhao.png', import.meta.url).href },
  { id: 'v10', category: Category.VEGETABLE, name: '土豆豆角', price: 30, image: new URL('./img/tudoudoujiao.png', import.meta.url).href },
  // v11 moved to TOP
  { id: 'v12', category: Category.VEGETABLE, name: '萝卜丝丸子', price: 36, image: new URL('./img/zhawanzi.png', import.meta.url).href },
  { id: 'v14', category: Category.VEGETABLE, name: '炒酸菜', price: 28, image: new URL('./img/chaosuancai.png', import.meta.url).href },
  { id: 'v15', category: Category.VEGETABLE, name: '咖喱土豆', price: 28, image: new URL('./img/galitudou.png', import.meta.url).href },
  ...
  // s2 moved to TOP
  { id: 's3', category: Category.SOUP, name: '紫菜蛋花汤', price: 18, image: new URL('./img/zicaitang.png', import.meta.url).href },
  ...
  { id: 'st1', category: Category.STAPLE, name: '疙瘩汤', price: 15, image: new URL('./img/gedatang.png', import.meta.url).href },
  { id: 'st2', category: Category.STAPLE, name: '葱油拌面', price: 16, image: new URL('./img/congyoubanmian.png', import.meta.url).href },
  { id: 'st3', category: Category.STAPLE, name: '油泼面', price: 18, image: new URL('./img/youpomian.png', import.meta.url).href },
  { id: 'st4', category: Category.STAPLE, name: '打卤面', price: 18, image: new URL('./img/dalumian.png', import.meta.url).href },
  { id: 'st5', category: Category.STAPLE, name: '牛肉面', price: 24, image: new URL('./img/niuroumian.png', import.meta.url).href },
  { id: 'st6', category: Category.STAPLE, name: '麻辣肉酱面', price: 20, image: new URL('./img/roujiangmian.png', import.meta.url).href },
  { id: 'st7', category: Category.STAPLE, name: '炒面', price: 16, image: new URL('./img/chaomian.png', import.meta.url).href },
  { id: 'st8', category: Category.STAPLE, name: '麻酱拌面', price: 15, image: new URL('./img/majiangmian.png', import.meta.url).href },
  ...
  { id: 'st11', category: Category.STAPLE, name: '肉夹馍', price: 8, image: new URL('./img/roujiamo.png', import.meta.url).href },
  { id: 'st12', category: Category.STAPLE, name: '韭菜盒子', price: 6, image: new URL('./img/jiucaihezi.png', import.meta.url).href },
  { id: 'st13', category: Category.STAPLE, name: '饺子', price: 22, image: new URL('./img/jiaozi.png', import.meta.url).href },
  { id: 'st14', category: Category.STAPLE, name: '奥尔良鸡肉包子', price: 4, image: new URL('./img/baozi.png', import.meta.url).href },
  { id: 'st15', category: Category.STAPLE, name: '馄饨', price: 18, image: new URL('./img/huntun.png', import.meta.url).href },
  { id: 'st16', category: Category.STAPLE, name: '炸薯条', price: 15, image: getRealImg('french_fries_basket_ketchup', 'st16') },
  { id: 'st17', category: Category.STAPLE, name: '蛋炒饭', price: 18, image: new URL('./img/danchaofan.png', import.meta.url).href },
  ...
  { id: 'st21', category: Category.STAPLE, name: '里脊大肉饼', price: 15, image: new URL('./img/shouzhuabing.png', import.meta.url).href },
  { id: 'st22', category: Category.STAPLE, name: '肉松火腿寿司', price: 18, image: new URL('./img/shousi.png', import.meta.url).href },
  { id: 'st23', category: Category.STAPLE, name: '韩式拌饭', price: 26, image: new URL('./img/hanshibanfan.png', import.meta.url).href },
  { id: 'st24', category: Category.STAPLE, name: '茶叶蛋', price: 2, image: new URL('./img/chayedan.png', import.meta.url).href },
  { id: 'st25', category: Category.STAPLE, name: '豆沙饼', price: 8, image: new URL('./img/tudoubing.png', import.meta.url).href },
  ...
  { id: 'st28', category: Category.STAPLE, name: '烧麦', price: 16, image: new URL('./img/shaomai.png', import.meta.url).href },
  { id: 'st29', category: Category.STAPLE, name: '手抓饼', price: 10, image: new URL('./img/shouzhuabing.png', import.meta.url).href },
  { id: 'st30', category: Category.STAPLE, name: '花卷', price: 3, image: new URL('./img/huajuan.png', import.meta.url).href },
  ...
  { id: 'st33', category: Category.STAPLE, name: '香肉饭', price: 35, image: getRealImg('claypot_rice_meat_casserole', 'st33') },
  ...
  { id: 'd6', category: Category.DESSERT, name: '酒酿赤豆小圆子', price: 20, image: new URL('./img/xiaoyuanzi.png', import.meta.url).href },
